...
import com.briup.exam.service.impl.PaperServiceImpl;
import com.briup.exam.service.impl.PaperSubjectServiceImpl;
import com.briup.exam.service.impl.SubjectServiceImpl;
import com.briup.exam.service.impl.UserServiceImpl;
import com.opensymphony.xwork2.ActionSupport;

@Controller
public class PaperAction extends ActionSupport implements ApplicationAware,SessionAware {
    ...
    public String savePaper() {
        ...
        paper.setUser((User)sesMap.get("user"));
    ...
    @Action(value = "/paperExport", results = {
            @Result(location = "/paperexport.jsp")})
    public String paperExport() {
        System.out.println("to paperPreview...");
        System.out.println("lijun.....");
        if (exportId != null) {
            Paper paper = paperService.findById(exportId); // 拿到对应试卷
    ...
    @Action(value = "/paperExportDetail", results = {
            @Result(location = "/WEB-INF/jsp/paper/paperexport.jsp")})
    public String paperExportDetail() throws UnsupportedEncodingException {
