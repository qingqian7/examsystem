...
<div class="editingarea">
    ...
    <div class="c_editview">
        ...
        <%--题目列表--%>
        <div style="width: 400px;left: 50%;margin-left: 100px;position: relative;float: left;">
            <h2 style="margin-top: 20px;">一、单选题 <span class="">(${radioPoints})</span></h2>
            ...
            <c:forEach items="${radioPSList}" var="ps" varStatus="s">
                <div class="subject">
                    ...
                    <ul style="margin-top: -20px;margin-left: 18px;">
